...
import { Plus, Edit, Trash2, Shield, Users, Eye, Settings, Key, Copy } from "lucide-react";
...
const roleDescriptions = {
  ...
  manager: "Can manage assets, transfers, and repairs",
  operator: "Can add and edit assets, create transfers",
              ...
              {users.map((user: User) => {
                ...
                return (
                  <TableRow key={user.id}>
                    ...
                    <TableCell>
                      <Badge variant={roleColors[user.role as UserRole]} className="gap-1">
